    ...
    <section id="upload" className="py-12 pb-2">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-md border border-slate-200/50 max-w-2xl mx-auto">
        ...
        <button
          ...
          className="mt-6 w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:from-emerald-700 hover:to-teal-700 transition-all duration-200"
        >
          Run Detection
        </button>
      </div>
